...
| `dr_showntell` | WandB parsing playground. Regex-based run classification; legacy merge scripts have been removed in favour of DuckDB ingestion (`datadec/notebooks/duck_wandb.py`). | `src/dr_showntell/run_id_parsing.py`. | — |
