...
| `dr_showntell` | Table-display utilities (Rich/FancyTable) originally built for WandB demos; parsing logic has been migrated to `dr_ingest`. | `src/dr_showntell/fancy_table.py`, `console_components.py`, `table_formatter.py`. | — |
